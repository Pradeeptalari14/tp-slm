# 🔧 Troubleshooting Guide — Local SLM Studio
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-slm/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/slm/)
